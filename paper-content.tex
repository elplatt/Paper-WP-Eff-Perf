...
We also perform agent-based simulations to determine whether social learning on an NK model can
...
We also propose a novel local majority-based social learning strategy that is both more efficient and higher
...
\item Using agent-based modeling, we show that the performance and efficiency of some networked learning strategies depends on degree distribution.
\end{itemize}
...
Section \ref{sec:sim} describes the methodology and results of our agent-based models,
...
The above trade-off between convergence time, optimality, and learning strategy
